...
class QDDPOptimizer(Optimizer):
    r"""An optimizer for QDDP Optimization.
    ...
    def __init__(self, model: nn.Module, curv_type: str, curv_shapes: dict, curv_kwargs: dict,
                 ...
                 acc_steps=1, bias_correction=False,
...
class DistributedSecondOrderOptimizer(QDDPOptimizer):
